...
def DQN(qnet, env, optimizer, start_epsilon=1, end_epsilon=0.05, exploration_fraction=0.1, gamma=1.0, nr_episodes=5000, max_t=100,
        replay_buffer_size=1000000, batch_size=32, warm_start_steps=1000, sync_rate=1024, train_frequency=8, doptimizer=None, n_step = 0, double_q_learning = False):
...
DQN(model, env, optimizer, gamma=gamma, start_epsilon=start_epsilon, end_epsilon=end_epsilon, exploration_fraction=exploration_fraction,
    nr_episodes=nr_episodes, max_t=max_t, warm_start_steps=500, sync_rate=128, replay_buffer_size=replay_buffer_size, train_frequency=2, double_q_learning=True, n_step=0)
